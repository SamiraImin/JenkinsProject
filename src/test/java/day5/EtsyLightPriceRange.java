...
public class EtsyLightPriceRange {

	/*
	 * go to etsy.com type in search "Light" click on the first product the price
	 * between $30-$50, if the first page not found, click go to the next page until
	 * it found get the name of the product then verify the price
	 */
	WebDriver driver;
